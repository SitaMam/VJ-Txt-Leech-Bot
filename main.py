    ...
    try:
        for i in range(count - 1, len(links)):
            ...
            if "youtu" in url:
                ...
                ytf = f"b[height<={raw_text2}][ext=mkv]/bv[height<={raw_text2}][ext=mkv]+ba[ext=mkv]/b[ext=mkv]"
            else:
            ...
            try:
                ...
                cc = (
                    f"╭━━━━━━━━━━━╮\n"
                    f"💫 𝐕ɪᴅᴇᴏ 𝐈𝐃 : {str(count).zfill(3)}\n"
                    f"╰━━━━━━━━━━━╯\n"
                    f"📁𝐓ɪᴛʟᴇ : {𝗻𝗮𝗺𝗲𝟭}{MR}.mkv\n\n"
                    f"📚𝐂ᴏᴜʀꜱᴇ : {raw_text0}\n\n"
                    f"📥𝖣𝗈𝗐𝗇𝗅𝗈𝖺𝖽𝖾𝖽 𝖡𝗒 : ShieldedSaver❤️"
                )
